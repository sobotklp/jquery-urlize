...
var wrap = function($) {
  ...
  var urlPattern = new RegExp('(?:(?:http|ftp)s?://)?' + // optional scheme
    '(?:(?:[A-Z0-9](?:[A-Z0-9-]{0,61}[A-Z0-9])?\\.)+(?:' + tlds + '\\.?)|' +  // domain
    'localhost|' + // localhost
